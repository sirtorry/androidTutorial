package com.torryyang.buttonclickcounter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ourMessage = (TextView) findViewById(R.id.textView2);
...
//        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Toast toastMesssage = Toast.makeText(this, "text value is now " + ourMessage.getText(), Toast.LENGTH_LONG);
            toastMesssage.show();
            numTimesClicked = 0;
            return true;
        }
